...
| 버전 | 날짜 | 주요 변경사항 |
|------|------|--------------|
| v1.0 | 2025-10-13 | 초기 구현 (속도 기반 검출) |
| v1.1 | 2025-10-13 | Heading 기반 검출로 변경 |
| v1.2 | 2025-10-13 | Lanelet 검색 거리 증가 (5m → 15m) |
| v1.3 | 2025-10-13 | 디버그 로그 추가 |
| v1.4 | 2025-10-13 | 위치 기반 Stable ID 구현 |
